...
@interface ParentsFiledViewController ()

@end

@implementation ParentsFiledViewController
...
- (void)setNaviBar {
    ...
    UIImage *imageR = [UIImage imageNamed:@"相机"];
    UIBarButtonItem *itemR = [UIBarButtonItem item:imageR selImage:nil target:self action:@selector(presentMine)];
    self.navigationItem.rightBarButtonItem = itemR;

    self.navigationItem.title = @"家长圈";
